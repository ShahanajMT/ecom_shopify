    ...
    return Scaffold(
      bottomNavigationBar: Obx(
        ()=> NavigationBar(
          ...
          onDestinationSelected: (index) => controller.slelectedIndex.value = index,
      ...
      body: Obx(() => controller.screens[controller.slelectedIndex.value])
    );
  }
}

class NavigationController extends GetxController {
  final Rx<int> slelectedIndex = 0.obs;
  final screens = [
    const HomePage(),
